 ...
 */
namespace SchumacherFM\Block\Plugin\Backend\Page;
...
class RequireJs extends \Magento\Framework\View\Element\Template
{
    ...
    {
        Zend_Debug::dump(get_class($subject));
    ...
    protected function _getPaceHtml()
    {
        ...
        if (true === empty($pace)) {
            ...
            $cache->save($pace, $cacheKey, [Mage_Core_Model_Layout_Update::LAYOUT_GENERAL_CACHE_TAG]);
        }
        return $pace;
    }
